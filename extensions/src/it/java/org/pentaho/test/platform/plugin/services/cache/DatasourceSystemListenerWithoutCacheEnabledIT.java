...
public class DatasourceSystemListenerWithoutCacheEnabledIT extends BaseTest {

  private static final String SOLUTION_PATH = TestResourceLocation.TEST_RESOURCES + "/cache-solution1";
  private static final String ALT_SOLUTION_PATH = TestResourceLocation.TEST_RESOURCES + "/cache-solution1";
  private static final String PENTAHO_XML_PATH = "/system/pentaho.xml";
  // private static final String DEFAULT_SPRING_CONFIG_FILE_NPentahoURLRewriterTestAME = "pentahoObjects.spring.xml";
