...
public class SessionCachingMetadataDomainRepositoryIT extends BaseTest {

  private static final String SOLUTION_PATH = TestResourceLocation.TEST_RESOURCES + "/metadata-solution"; //$NON-NLS-1$
  private static final String ALT_SOLUTION_PATH = TestResourceLocation.TEST_RESOURCES + "/metadata-solution"; //$NON-NLS-1$
