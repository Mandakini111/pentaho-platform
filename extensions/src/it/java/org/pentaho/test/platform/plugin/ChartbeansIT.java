...
public class ChartbeansIT {
  ...
  protected File getOriginalFile( String fileName ) {
    return new File(
        System.getProperty( "user.dir" ) + File.separator + TestResourceLocation.TEST_RESOURCES + File.separator + "solution" + File.separator + "test" + File.separator + "chartbeans" + //$NON-NLS-1$//$NON-NLS-2$
