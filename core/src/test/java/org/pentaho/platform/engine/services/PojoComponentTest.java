...
public class PojoComponentTest extends BaseTest {
    ...
    try {
      ...
      IRuntimeContext runtimeContext =
          solutionEngine.execute( xactionStr, "test1a.xaction", "empty action sequence test", false, true, null, false, //$NON-NLS-1$ //$NON-NLS-2$
              providers, null, null, new SimpleUrlFactory( "" ), new ArrayList() );
  ...
  public void testSimplePojoSettings() {
    ...
    try {
      ...
      PojoComponentTest.doneCalled = false;
      IRuntimeContext runtimeContext =
          solutionEngine.execute( xactionStr, "pojo1b.xaction", "empty action sequence test", false, true, null, false, //$NON-NLS-1$ //$NON-NLS-2$
  ...
  public void testSimplestCase() {
    ...
    try {
      ...
      PojoComponentTest.doneCalled = false;
      IRuntimeContext runtimeContext =
          solutionEngine.execute( xactionStr, "pojo4.xaction", "empty action sequence test", false, true, null, false, //$NON-NLS-1$ //$NON-NLS-2$
              new HashMap(), null, null, new SimpleUrlFactory( "" ), new ArrayList() );
      IActionParameter param = runtimeContext.getOutputParameter( "output1" );
      assertNotNull( "RuntimeContext is null", runtimeContext );
      assertNotNull( "param is null", param );
  ...
  public void testRuntimeInputsAndOutputs() {
    ...
    try {
      ...
      IRuntimeContext runtimeContext =
          solutionEngine.execute( xactionStr, "pojo5.xaction", "empty action sequence test", false, true, null, false, //$NON-NLS-1$ //$NON-NLS-2$
              new HashMap(), null, null, new SimpleUrlFactory( "" ), new ArrayList() );
      assertNotNull( "RuntimeContext is null", runtimeContext );
      assertEquals( "Action sequence execution failed", runtimeContext.getStatus(),
          IRuntimeContext.RUNTIME_STATUS_SUCCESS );
  ...
  public void testMissingClassSetting() {
    ...
    try {
      ...
      IRuntimeContext runtimeContext =
          solutionEngine.execute( xactionStr, "test", "invalid class setting test", false, true, null, false, //$NON-NLS-1$ //$NON-NLS-2$
              new HashMap(), null, null, new SimpleUrlFactory( "" ), new ArrayList() );
      assertNotNull( "RuntimeContext is null", runtimeContext );
  ...
  public void testStreamingPojo() {
    ...
    try {
      ...
      IRuntimeContext runtimeContext =
          solutionEngine.execute( xactionStr, "test1.xaction", "empty action sequence test", false, true, null, false, //$NON-NLS-1$ //$NON-NLS-2$
              new HashMap(), outputHandler, null, new SimpleUrlFactory( "" ), new ArrayList() );
