...
public class DefaultUnifiedRepositoryBase implements ApplicationContextAware {
  ...
  protected ITenantedPrincipleNameResolver roleNameUtils =
      new DefaultTenantedPrincipleNameResolver( DefaultTenantedPrincipleNameResolver.ALTERNATE_DELIMETER );
  ...
  public void loginAsRepositoryAdmin() {
    ...
    final Collection<GrantedAuthority> repositoryAdminAuthorities =
        Collections.singletonList( new SimpleGrantedAuthority( superAdminRoleName ) );
          ...
          if ( tenantRootFolder != null ) {
            ...
            if ( tenantHomeFolder == null ) {
              ...
              aclsForTenantHomeFolder =
                  new RepositoryFileAcl.Builder( userSid ).ace( tenantAuthenticatedRoleSid, EnumSet.of(
  ...
  public void setApplicationContext( ApplicationContext applicationContext ) throws BeansException {
    ...
    roleBindingDao =
        (IRoleAuthorizationPolicyRoleBindingDao) applicationContext.getBean(
            "roleAuthorizationPolicyRoleBindingDaoTxn" );
    roleBindingDaoTarget =
        (IRoleAuthorizationPolicyRoleBindingDao) applicationContext.getBean(
            "roleAuthorizationPolicyRoleBindingDaoTarget" );
